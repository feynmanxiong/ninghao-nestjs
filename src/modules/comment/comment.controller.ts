...
import { User as UserEntiy } from '../user/user.entity';
...
export class CommentController {
    ...
    async storePostComment(
        ...
        return await this.commentService.storeDogsComment(id, user, data);
    }
    ...
    async showDogsComments(
        @Param('id', ParseIntPipe) id: number  
    ){
        return await this.commentService.showDogsComments(id);
    }
